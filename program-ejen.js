...
function setAdminContact(phone, name='Admin WAHH AIR') {
  ...
  const message = encodeURIComponent('Hai Admin WAHH AIR, saya berminat untuk tahu lebih lanjut tentang Program Ejen WAHH AIR.');
  ...
  if (note) note.textContent = `Hubungi ${name} melalui WhatsApp untuk pertanyaan Program Ejen.`;
}
